...
public class BookingGUI_MsgPur4 extends JDialog {
	...
	public static void main(String[] args) {
		try {
			BookingGUI_MsgPur4 dialog = new BookingGUI_MsgPur4();
	...
	public BookingGUI_MsgPur4() {
		...
		{
			JLabel lblNewLabel = new JLabel("\uC794\uC561\uC774 \uBD80\uC871\uD569\uB2C8\uB2E4.");
