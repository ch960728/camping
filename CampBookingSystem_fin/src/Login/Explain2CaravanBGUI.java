...
public class Explain2CaravanBGUI extends JDialog {
	...
	public static void main(String[] args) {
		try {
			Explain2CaravanBGUI dialog = new Explain2CaravanBGUI();
	...
	public Explain2CaravanBGUI() {
		...
		lblcaravan1.setIcon(new ImageIcon("./images/카라반B설명.jpg"));
